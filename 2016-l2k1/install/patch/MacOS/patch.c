...
//  OS<ADN>
//
//  Created by Benjamin Cohen on 02/04/2017.
...
int main(int argc, const char * argv[]) {
    ...
    char *install[MAX]={
        "python3 -m pip install --user tkFontChooser",
    ...
    char *uninstall[MAX]={
        "python3 -m pip uninstall --yes tkFontChooser",
        "python3 -m pip uninstall --yes opencv-python",
        "python3 -m pip uninstall --yes scipy",
        "python3 -m pip uninstall --yes numpy",
        "python3 -m pip uninstall --yes matplotlib"
    };
    ...
    do{
        ...
        if(choix==0){
            ...
            printf("*                                                                                       *\n");
            printf("*                                                                                       *\n");
            printf("*          Copyright © 2017 Benjamin Cohen. All rights reserved                         *\n");
            printf("*                                                                                       *\n");
            printf("*                                                                                       *\n");
            ...
            printf("*                pour l'exécution du logiciel L2K1 :                                    *\n");
            printf("*                                                                                       *\n");
            printf("*                                                                                       *\n");
            printf("*                 # tkFontChooser                                                       *\n");
            printf("*                 # opencv                                                              *\n");
            printf("*                 # scipy                                                               *\n");
            printf("*                 # numpy                                                               *\n");
            printf("*                 # matplotlib                                                          *\n");
            ...
            printf("*                                                                                       *\n");
            printf("*                Mail de contact : benjamin.cohen4@etu.parisdescartes.fr                *\n");
            printf("*                                                                                       *\n");
            printf("*                                                                                       *\n");
            printf("*=======================================================================================*\n");
